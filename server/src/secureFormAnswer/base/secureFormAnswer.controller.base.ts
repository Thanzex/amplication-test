...
import { SecureFormAnswerWhereUniqueInput } from "./SecureFormAnswerWhereUniqueInput";
import { SecureFormAnswerFindManyArgs } from "./SecureFormAnswerFindManyArgs";
import { SecureFormAnswerUpdateInput } from "./SecureFormAnswerUpdateInput";
import { SecureFormAnswer } from "./SecureFormAnswer";
@swagger.ApiBearerAuth()
export class SecureFormAnswerControllerBase {
  constructor(
  ...
  @swagger.ApiCreatedResponse({ type: SecureFormAnswer })
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async create(
    @common.Body() data: SecureFormAnswerCreateInput,
    ...
    return await this.service.create({
      data: {
        ...
        secureForms: data.secureForms
          ? {
              connect: data.secureForms,
            }
          : undefined,
  ...
  @swagger.ApiOkResponse({ type: [SecureFormAnswer] })
  ...
  async findMany(
    ...
    const args = plainToClass(SecureFormAnswerFindManyArgs, request.query);
  ...
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async findOne(
    @common.Param() params: SecureFormAnswerWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
  ...
  async update(
    @common.Param() params: SecureFormAnswerWhereUniqueInput,
    @common.Body()
    data: SecureFormAnswerUpdateInput,
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<SecureFormAnswer | null> {
    const permission = this.rolesBuilder.permission({
      role: userRoles,

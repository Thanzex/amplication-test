...
export class UserControllerBase {
  ...
  @common.Get("/:id/secureFormAnswers")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "read",
    possession: "any",
  ...
  async findManySecureFormAnswers(
    @common.Req() request: Request,
    @common.Param() params: UserWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
    ...
    const results = await this.service.findSecureFormAnswers(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  @common.Post("/:id/secureFormAnswers")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async createSecureFormAnswers(
    @common.Param() params: UserWhereUniqueInput,
  ...
  @common.Patch("/:id/secureFormAnswers")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async updateSecureFormAnswers(
    @common.Param() params: UserWhereUniqueInput,
  ...
  @common.Delete("/:id/secureFormAnswers")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async deleteSecureFormAnswers(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: UserWhereUniqueInput[],
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<void> {
